...
<<<<<<< HEAD
function eapearson_ReadsSetEditor(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
=======
function ReadsSetEditor(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
>>>>>>> master
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.save_read_set = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_ReadsSetEditor.save_read_set",
            [params], 1, _callback, _errorCallback);
    };
 
     this.save_reads_set_v1 = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "ReadsSetEditor.save_reads_set_v1",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_ReadsSetEditor.status",
            [], 1, _callback, _errorCallback);
    };
